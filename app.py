...
sys.path.append("c:/Users/Rehan/Desktop/python/terminal_velocity")
from calulate_terminal_velocity import get_terminal_velocity
...
if st.button("Calculate"):
    ...
    if len(fluid_list) != len(viscosity_list):
        ...
        df.to_csv("c:/Users/Rehan/Desktop/python/terminal_velocity/results.csv", index=False)
